...
def main():
    ...
    generate_html_rankings(all_buckets, 'all_data_rankings.html', 
    ...
    generate_html_rankings(recent_buckets, 'recent_data_rankings.html', 
    ...
    print("  - all_data_rankings.html")
    print("  - recent_data_rankings.html")
